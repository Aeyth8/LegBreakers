...
static_assert(offsetof(FAkPS4AdvancedInitializationSettings, bPlotQueueLevel) == 0x00003D, "Member 'FAkPS4AdvancedInitializationSettings::bPlotQueueLevel' has a wrong offset!");
