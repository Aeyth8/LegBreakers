...
// Parameters:
// class UOdyWidget*                       Widget                                                 (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void ULoadingScreenManager::OnLoadingScreenWidgetDisplayStateChanged(class UOdyWidget* Widget, EOdyWidgetDisplayState OldState, EOdyWidgetDisplayState NewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LoadingScreenManager", "OnLoadingScreenWidgetDisplayStateChanged");

	Params::LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged Parms{};
