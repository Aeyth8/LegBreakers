...
#include "BUF_Item_GlitchMarkPassive_classes.hpp"
#include "BUF_Item_GlitchMarkPassive_parameters.hpp"
...
void UBUF_Item_GlitchMarkPassive_C::OnPostApplyOutgoingHit(class AMatchaSnapNetCharacterEntity* BuffedCharacter, class AActor* TargetHit, class AActor* PreviousTargetHit, const struct FMatchaHitData& HitData, uint8 AppliedHitFlags, EMatchaCharacterMontageType MontageDuringHit, EObjectRarity BuffRarity) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BUF_Item_GlitchMarkPassive_C", "OnPostApplyOutgoingHit");

	Params::BUF_Item_GlitchMarkPassive_C_OnPostApplyOutgoingHit Parms{};
