...
namespace Offsets
{
	constexpr int32 GObjects          = 0x085E32D0;
	constexpr int32 AppendString      = 0x011236F0;
	constexpr int32 GNames            = 0x0852BF00;
	constexpr int32 GWorld            = 0x08766FB8;
	constexpr int32 ProcessEvent      = 0x0132E0B0;
