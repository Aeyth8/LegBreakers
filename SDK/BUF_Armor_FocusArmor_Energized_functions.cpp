...
#include "BUF_Armor_FocusArmor_Energized_classes.hpp"
#include "BUF_Armor_FocusArmor_Energized_parameters.hpp"
...
void UBUF_Armor_FocusArmor_Energized_C::OnCharacterMontageStart(class AMatchaSnapNetCharacterEntity* BuffedCharacter, float MontageDuration, EMatchaCharacterMontageType MontageType, EMatchaCharacterMontageType PreviousMontageType, EObjectRarity BuffRarity) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BUF_Armor_FocusArmor_Energized_C", "OnCharacterMontageStart");

	Params::BUF_Armor_FocusArmor_Energized_C_OnCharacterMontageStart Parms{};
