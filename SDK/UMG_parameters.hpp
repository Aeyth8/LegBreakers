...
// Function UMG.ListViewBase.SetAnalogScrollMultiplier
// 0x0004 (0x0004 - 0x0000)
struct ListViewBase_SetAnalogScrollMultiplier final
{
public:
	float                                         InAnalogScrollMultiplier;                          // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ListViewBase_SetAnalogScrollMultiplier) == 0x000004, "Wrong alignment on ListViewBase_SetAnalogScrollMultiplier");
static_assert(sizeof(ListViewBase_SetAnalogScrollMultiplier) == 0x000004, "Wrong size on ListViewBase_SetAnalogScrollMultiplier");
static_assert(offsetof(ListViewBase_SetAnalogScrollMultiplier, InAnalogScrollMultiplier) == 0x000000, "Member 'ListViewBase_SetAnalogScrollMultiplier::InAnalogScrollMultiplier' has a wrong offset!");

// Function UMG.ListViewBase.SetAnalogScrollStick
// 0x0001 (0x0001 - 0x0000)
struct ListViewBase_SetAnalogScrollStick final
{
public:
	EAnalogScrollStick                            InAnalogScrollStick;                               // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ListViewBase_SetAnalogScrollStick) == 0x000001, "Wrong alignment on ListViewBase_SetAnalogScrollStick");
static_assert(sizeof(ListViewBase_SetAnalogScrollStick) == 0x000001, "Wrong size on ListViewBase_SetAnalogScrollStick");
static_assert(offsetof(ListViewBase_SetAnalogScrollStick, InAnalogScrollStick) == 0x000000, "Member 'ListViewBase_SetAnalogScrollStick::InAnalogScrollStick' has a wrong offset!");
...
// Function UMG.ScrollBox.SetAnalogScrollMultiplier
// 0x0004 (0x0004 - 0x0000)
struct ScrollBox_SetAnalogScrollMultiplier final
{
public:
	float                                         InAnalogScrollMultiplier;                          // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ScrollBox_SetAnalogScrollMultiplier) == 0x000004, "Wrong alignment on ScrollBox_SetAnalogScrollMultiplier");
static_assert(sizeof(ScrollBox_SetAnalogScrollMultiplier) == 0x000004, "Wrong size on ScrollBox_SetAnalogScrollMultiplier");
static_assert(offsetof(ScrollBox_SetAnalogScrollMultiplier, InAnalogScrollMultiplier) == 0x000000, "Member 'ScrollBox_SetAnalogScrollMultiplier::InAnalogScrollMultiplier' has a wrong offset!");

// Function UMG.ScrollBox.SetAnalogScrollStick
// 0x0001 (0x0001 - 0x0000)
struct ScrollBox_SetAnalogScrollStick final
{
public:
	EAnalogScrollStick                            InAnalogScrollStick;                               // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ScrollBox_SetAnalogScrollStick) == 0x000001, "Wrong alignment on ScrollBox_SetAnalogScrollStick");
static_assert(sizeof(ScrollBox_SetAnalogScrollStick) == 0x000001, "Wrong size on ScrollBox_SetAnalogScrollStick");
static_assert(offsetof(ScrollBox_SetAnalogScrollStick, InAnalogScrollStick) == 0x000000, "Member 'ScrollBox_SetAnalogScrollStick::InAnalogScrollStick' has a wrong offset!");
