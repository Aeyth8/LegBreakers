...
// Function CommonLoadingScreen.LoadingScreenManager.OnLoadingScreenWidgetDisplayStateChanged
// 0x0010 (0x0010 - 0x0000)
struct LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged final
{
public:
	class UOdyWidget*                             Widget;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged) == 0x000008, "Wrong alignment on LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged");
static_assert(sizeof(LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged) == 0x000010, "Wrong size on LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged");
static_assert(offsetof(LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged, Widget) == 0x000000, "Member 'LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged::Widget' has a wrong offset!");
static_assert(offsetof(LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged, OldState) == 0x000008, "Member 'LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged::OldState' has a wrong offset!");
static_assert(offsetof(LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged, NewState) == 0x000009, "Member 'LoadingScreenManager_OnLoadingScreenWidgetDisplayStateChanged::NewState' has a wrong offset!");
