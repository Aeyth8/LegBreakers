...
public:
	...
	bool                                          bTriggerOncePerTick;                               // 0x0041(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bConsumeInput;                                     // 0x0042(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bConsumesActionAndAxisMappings;                    // 0x0043(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bReserveAllMappings;                               // 0x0044(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TriggerEventsThatConsumeLegacyKeys;                // 0x0048(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInputActionValueType                         ValueType;                                         // 0x004C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInputActionAccumulationBehavior              AccumulationBehavior;                              // 0x004D(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UInputAction, bTriggerOncePerTick) == 0x000041, "Member 'UInputAction::bTriggerOncePerTick' has a wrong offset!");
static_assert(offsetof(UInputAction, bConsumeInput) == 0x000042, "Member 'UInputAction::bConsumeInput' has a wrong offset!");
static_assert(offsetof(UInputAction, bConsumesActionAndAxisMappings) == 0x000043, "Member 'UInputAction::bConsumesActionAndAxisMappings' has a wrong offset!");
static_assert(offsetof(UInputAction, bReserveAllMappings) == 0x000044, "Member 'UInputAction::bReserveAllMappings' has a wrong offset!");
static_assert(offsetof(UInputAction, TriggerEventsThatConsumeLegacyKeys) == 0x000048, "Member 'UInputAction::TriggerEventsThatConsumeLegacyKeys' has a wrong offset!");
static_assert(offsetof(UInputAction, ValueType) == 0x00004C, "Member 'UInputAction::ValueType' has a wrong offset!");
static_assert(offsetof(UInputAction, AccumulationBehavior) == 0x00004D, "Member 'UInputAction::AccumulationBehavior' has a wrong offset!");
